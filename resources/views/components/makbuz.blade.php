                ...
                <table class="table is-bordered is-fullwidth ">
                    ...
                    <tfoot>
                        <tr class="is-size-7 my-0">
                            <th>Toplam</th>
                            <th class="has-text-right">{{$record ? number_format($record->tutar, 2, ',', ' ') : ' '}}
                            </th>
                        </tr>
                    </tfoot>
                </table>
            ...
            <div class="column ">
                ...
                <div class="column">
                    <div class="columns">
                        ...
                        <div class="column has-text-right ">
                            <span
                                class="title is-size-1">{{$record ? number_format($record->tutar, 2, ',', ' ') : '__________'}}
                                &#8378;</span><br>
                            <span class="has-text-right">Daire No
                                <strong>{{$record ? $record->sakin_id : '___ '}}</strong>, Dönem
                                <strong>{{$record ? $record->donem : '____________'}}</strong></span>
                        </div>
                ...
                <div class="column has-text-centered">
                    ...
                    @if ($record && $record->sakin_id)
                        ...
                        {{$record ? $record->aciklama : '___ '}} olarak <strong>{{$record ? $yazi : '____'}}</strong> TL
                        alınmıştır.
                ...
                <div class="column">
                    ...
                    <div class="columns is-vcentered has-background-light mt-4">
                        <div class="column is-8 is-size-7">{{$bina->name}} Yöneticisi <br><span
                                class="has-text-grey">[Makbuzu Veren]</span></div>
